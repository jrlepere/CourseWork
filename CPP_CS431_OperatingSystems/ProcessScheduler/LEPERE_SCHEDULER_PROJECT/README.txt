...
.
.
CD to the src directory. Compile all .java files using the ‘$ javac *.java’ command. Next, run the Main class with the ‘$ java Main input.txt’ command, where input.txt is the formatted input file.
